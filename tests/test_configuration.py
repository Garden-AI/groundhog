...
class TestConfigResolverBasics:
    ...
    def test_resolve_decorator_only(self, tmp_path):
        """Test config resolution with only decorator config."""
        script_path = tmp_path / "test_script.py"
        script_path.write_text("# No PEP 723 metadata\nimport groundhog_hpc as hog\n")
...
class TestConfigResolverPep723Base:
    ...
    def test_resolve_pep723_base_config(self, pep723_script):
    ...
    def test_decorator_overrides_pep723(self, pep723_script):
    ...
    def test_dict_valued_keys_preserved_from_decorator_and_callsite(
        self, pep723_script
    ):
...
class TestConfigResolverPep723Variants:
    ...
    def test_resolve_pep723_variant_inherits_base(self, pep723_script):
    ...
    def test_resolve_variant_without_base(self, pep723_script):
...
class TestConfigResolverPrecedence:
    ...
    def test_full_precedence_chain(self, pep723_script):
...
class TestConfigResolverWorkerInit:
    ...
    def test_worker_init_concatenation(self, pep723_script):
    ...
    def test_worker_init_variant_concatenation(self, pep723_script):
...
class TestConfigResolverEndpointUUID:
    ...
    def test_endpoint_uuid_in_config(self, pep723_script):
...
class TestConfigResolverEdgeCases:
    ...
    def test_endpoint_not_in_pep723(self, pep723_script):
    ...
    def test_variant_not_in_pep723(self, pep723_script):
    ...
    def test_caching_pep723_metadata(self, pep723_script):
    ...
    def test_empty_pep723_tool_hog_section(self, pep723_script):
        """Test with PEP 723 metadata but no [tool.hog] section."""
        script_path = pep723_script(
            dependencies=["numpy"],
            endpoints={},  # No tool.hog section
        )
...
class TestConfigResolverNestedVariants:
    ...
    def test_resolve_three_level_variant(self, pep723_script):
    ...
    def test_resolve_error_when_variant_not_dict(self, pep723_script):
        """Test error when variant path points to non-dict value."""
        import pytest

        # Create a script with "gpu" as a string value, not a dict (invalid variant)
        script_path = pep723_script(
            endpoints={
                "anvil": {
                    "endpoint": "uuid-here",
                    "gpu": "v100",  # This will be written as a string, not a dict
                }
            }
        )
    ...
    def test_resolve_error_when_variant_missing(self, pep723_script):
...
class TestConfigResolverMultipleBaseEndpoints:
    ...
    def test_resolve_multiple_base_endpoints(self, pep723_script):
    ...
    def test_switch_base_endpoints_at_call_time(self, pep723_script):
    ...
    def test_multiple_base_endpoints_with_variants(self, pep723_script):
        ...
        assert anvil_gpu_result["endpoint"] == "5aafb4c1-27b2-40d8-a038-a0277611868f"
        ...
        assert polaris_gpu_result["endpoint"] == "a1b2c3d4-e5f6-7890-abcd-ef1234567890"
    ...
    def test_call_time_override_preserves_correct_base(self, pep723_script):
